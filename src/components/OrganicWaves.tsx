...
export const AsymmetricWaveTransition: React.FC<{
  ...
  bottomColor: string;
  className?: string;
  variant?: 'hero-to-body' | 'body-to-dark' | 'dark-to-light' | 'gentle';
}> = ({ bottomColor, className = '', variant = 'hero-to-body' }) => {
  if (variant === 'hero-to-body') {
    return (
      <div className={`w-full overflow-hidden leading-none relative z-10 ${className}`}>
        <svg
          viewBox="0 0 1440 140"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="w-full h-14 md:h-24 lg:h-32 block"
          preserveAspectRatio="none"
        >
          <path
    ...
    return (
      <div className={`w-full overflow-hidden leading-none relative z-10 ${className}`}>
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="w-full h-16 md:h-28 lg:h-36 block"
          preserveAspectRatio="none"
        >
          <path
